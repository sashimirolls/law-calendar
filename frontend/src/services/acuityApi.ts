...
//       }
//     });
//     console.log("Data Response: ", datesResponse);


//     const availableDates = Array.isArray(datesResponse.data.data)
//       ? datesResponse.data.data.map((item: { date: any }) => item.date)
//       : [];
...
//     const timesResponse = Array.isArray(datesResponse.data.data)
//       ? datesResponse.data.data.flatMap((item: { times: any[] }) =>
//           Array.isArray(item.times) ? item.times.map((timeObj) => timeObj.time) : []
//         )
//       : [];

//     return Array.isArray(timesResponse)
//       ? timesResponse.map((slot: any) => ({
//           datetime: slot || slot.time || slot.datetime,
//           isAvailable: true
//         }))
//       : [];
