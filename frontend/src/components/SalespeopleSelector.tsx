  ...
  return (
    <div className="bg-white rounded-lg shadow p-6 mb-6">
      ...
      {salespeople.length === 0 ? (
        <div className="text-center text-gray-600 my-4 p-4 border rounded-md bg-gray-50">
          <p className="font-medium">No salespeople selected</p>
        </div>
      ) : (
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {salespeople.map((person) => (
            <div
              ...
              className={`p-3 border rounded-md ${selectedPeople.includes(person)
